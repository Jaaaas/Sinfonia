...
you can download it from here [Sinfonia](https://github.com/Jaaaas/Sinfonia/releases/tag/v1.0.1) or from the releases) into the project and you can use its features.
